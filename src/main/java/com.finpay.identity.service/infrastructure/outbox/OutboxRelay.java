...
import com.finpay.identity.service.infrastructure.kafka.IdentityEventProducer;
...
public class OutboxRelay {
    ...
    private final IdentityEventProducer producer;
    private final boolean enabled;
    private final int batchSize;

    public OutboxRelay(
            OutboxRepository outboxRepository,
            IdentityEventProducer producer,

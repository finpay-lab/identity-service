...
/**
 * Publishes outbox payloads to the {@code finpay.identity} topic. Synchronous
...
public class IdentityEventProducer {
    ...
    private static final Logger log = LoggerFactory.getLogger(IdentityEventProducer.class);
    ...
    public IdentityEventProducer(
            KafkaTemplate<String, String> kafkaTemplate,
            @Value("${finpay.kafka.topic.identity}") String topic) {
    ...
    /** Key is the principal id so per-principal ordering is preserved. */

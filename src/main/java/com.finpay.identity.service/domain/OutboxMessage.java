...
public record OutboxMessage(
    ...
    public OutboxMessage withPublished(boolean published) {
        return new OutboxMessage(id, aggregateType, aggregateId, eventType, payload, eventId, published, createdAt);
    }
}